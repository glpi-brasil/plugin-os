...
class PluginOsConfig extends CommonDBTM {
   ...
   function showFormDisplay() {
      ...
      echo "</table></div>";
      Html::closeForm();
	  $botao_acom = Session::haveRight(Config::$rightname, UPDATE);
      echo "<form name='form' action='../plugins/os/front/os_acom.php' method='get'>\n";
      echo Html::hidden('config_context', ['value' => 'os']);
      echo Html::hidden('config_class', ['value' => __CLASS__]);
      echo "<input type='hidden' name='id' value='".$ID."'>";
      echo "<div class='center' id='tabsbody2'>\n";
      ...
      echo "<tr class='tab_bg_2'>\n";
      echo "<td colspan='4' class='center'>\n";
      echo "<input type='submit' name='update2' class='submit' value=\"" . __('Gerar OS - Entidade com Acompanhamento', 'os') . "\">\n";
      echo "</td></tr>\n";
      echo "</table></div>";
      Html::closeForm();
