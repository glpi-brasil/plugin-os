...
<tr><td width="50%"><b>Data/Hora de Início: </b><?php echo ($OsDataInternal);?></td><td><b>Data/Hora de Término: </b><?php echo ($OsDataInternalEntrega);?></td></tr>
<tr>
<td>
<?php
	if ( $Locations == null ) {
...
<tr><td colspan="2" style="background-color:<?php echo $CorPlugin; ?> !important";><center><b><font color="<?php echo $CorTextoPlugin; ?>">ACOMPANHAMENTO</font></b></center></td></tr>
<tr><td height="90" colspan="2" valign="top" style="padding:10px;">
<?php 

	if ( $ResTicketFollowups == null ) {
		echo "<br><hr><br><hr><br><hr><br>";
	} else {
		while ($TicketFollowups = $DB->fetch_assoc($ResTicketFollowups)){
			echo "<b>", $TicketFollowups['date'], '</b> ', $TicketFollowups['content'];
			echo "<br>";
		}	
	}
